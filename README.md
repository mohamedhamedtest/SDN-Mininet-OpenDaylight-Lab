...
This project documents a practical Software-Defined Networking (SDN) laboratory environment developed using Mininet and SDN Controllers.

The project started with a pre-built SDN Controller environment provided by HPE, integrated with Mininet, virtual switches, and hosts to create and manage a software-defined network.
